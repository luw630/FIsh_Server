...
class ListenerGateWay : public VerifyListenerSession, public PacketHandlerMgr<ClientPacketHandler>
{
public:
	...
	void bindGateway(SessionGateWay* pSession, int32 gatewayId);
private:
